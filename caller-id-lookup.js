 ...
 *
 * TESTBED CREDENTIALS - Safe for testing
 *
 * Search Strategy:
 * 1. First search CDC (Change Data Capture) for recent changes (fast)
 * 2. Then paginate through /clients endpoint with ItemsPerPage=20
 *    (NOTE: Meevo returns different results with different ItemsPerPage values!)
 */
...
async function getToken() {
  ...
  console.log('[Auth] Getting fresh TESTBED token...');
  ...
  console.log('[Auth] TESTBED token obtained');
  return token;
}
